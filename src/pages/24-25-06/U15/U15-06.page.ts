...
@Component({
  selector: 'page-U15-06',
  templateUrl: './U15-06.page.html',
  styleUrls: ['./U15-06.page.scss'],
  encapsulation: ViewEncapsulation.None,
  standalone: true,
  imports: [MatchesComponent, TableComponent, NgIf, AsyncPipe],
})
export class U1506Page implements OnInit {
  ...
  private setData(data: any[]) {
    const resultados: any[] = data?.find((d) => d.name === 'U15')?.data;
